...
\entry{2em}{Xp{8em}}{%
	...
	\begin{itemize}
	\tightlist
	\item 案例1：从中国地震台网获取2012年4月至2017年8月5级及以上的地震数据
	\item 案例2：从美国地质调查局获取1973年至2010年世界各地6级及以上地震数据集
	\item 主要工作：基于 ggplot2和animotion等R包，制作动态、平面和立体时空数据可视化
	\end{itemize}
	{\heiti 社区开发者网络可视化} 
	\vspace*{-.45cm}
	\begin{itemize}
	\tightlist
	\item 分析目标：可视化R语言社区中开发者相互合作的关系网络、挖掘出对社区贡献大的组织、个人
	\item 主要工作：抓取CRAN官方11000+ R包信息、RStudio官网下载日志，正则表达式提取开发者、贡献者字段，清洗后，建立有向图网络，使用ggplot2等可视化包，呈现贡献关系网络。
	\end{itemize}
}
\heading{项目实战}
\entry{2em}{Xp{8em}}{%
	...
	\begin{itemize}
	\tightlist
	\item 分析目标：定性与定量相结合的方法找出与遗传性疾病相关的基因位点
	\item 使用 Pearson 卡方检验降维，岭回归、Lasso 回归和适应性 Lasso 回归做特征提取，利用 Cp、AICC、GCV、BIC 准则做特征选择，logistic分布做损失函数，得到很可能是致病位点的集合。
	\end{itemize}
    {\heiti 可重复的定时数据分析报告}
	\vspace*{-.45cm}
	\begin{itemize}
	\tightlist
	\item 在大规模新浪运维日志数据上，基于 Docker、Clickhose 和 R Markdown 制作数据分析报告
	\end{itemize}	
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
